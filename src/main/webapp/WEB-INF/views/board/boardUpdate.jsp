        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">커뮤니티 내용 수정</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                <th>제목</th>
                                <td>
                                    <input id="board-title" name="title" value="${post.title}" type="text"
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="board-content" class="form-control" name="message"
                                              placeholder="내용을 입력하세요." rows="7">${post.content}</textarea>
                                </td>
                            </tr>
                        </table>
