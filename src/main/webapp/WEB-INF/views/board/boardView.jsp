        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">커뮤니티 내용</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                <th>제목</th>
                                <td>
                                    <!--<input id="board-title" name="title" type="text" placeholder="제목을 입력하세요." class="form-control">-->
                            ...
                            <tr>
                                <th>작성자</th>
                                <td>
                                    <!--<input id="post-username" name="title" type="text" placeholder="" class="form-control"> -->
                            ...
                            <tr>
                                <th>내용</th>
                                <td>
                                    <textarea id="board-content" class="form-control" name="message" placeholder="내용을 입력하세요." rows="7" readonly>${post.content}</textarea>
                                </td>
                            </tr>
                        </table>
...
<script>
    $('#board-edit-btn').on('click', function () {
        if(confirm('글 수정을 하시겠습니까?')) {
            location.href='/community/edit/' + ${post.boardNo};
        }
    });
