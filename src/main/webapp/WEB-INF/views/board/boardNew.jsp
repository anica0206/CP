...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="col-10 d-flex flex-column">
        ...
        <div class="container-fluid">
            ...
            <p class="mb-4">
                자유게시판 입니다. 미풍양속을 해치지 않는 범위 내에서 자유롭게
                작성해주세요.
            </p>
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                <th>제목</th>
                                <td>
                                    <input id="board-title" name="title" type="text" placeholder="제목을 입력하세요."
                                           class="form-control">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea id="board-content" class="form-control" name="message"
                                              placeholder="내용을 입력하세요." rows="7"></textarea>
                                </td>
                            </tr>
                        </table>
                        <div class="text-right">
                            <button id="board-submit-btn" class="btn btn-primary btn-icon-split">
