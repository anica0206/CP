    ...
    <body id="page-top">
      ...
      <div id="wrapper">
        ...
        <div id="content-wrapper" class="col-10 d-flex flex-column">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">훈련프로그램 추천</h1>
          <p class="mb-4">
              ...
              <div class="row justify-content-end">
                <div class="col-4">
                  <div class="row justify-content-start">
                    <div class="col-4">
                      <button class="btn btn-outline-primary dropdown-toggle" type="button" id="dropdownJob"
                        data-toggle="dropdown" aria-expanded="false">
                        <span>희망 직종</span>
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="dropdownJob">
                        <li><a class="dropdown-item" href="#">JAVA 개발자</a></li>
                        <li><a class="dropdown-item" href="#">Python 개발자</a></li>
                      </ul>
                    </div>
                    <div class="col-4">
                      <button class="btn btn-outline-primary dropdown-toggle" type="button" id="dropdownArea"
                        data-toggle="dropdown" aria-expanded="false">
                        <span>희망 지역</span>
                      </button>
              ...
              <div class="table-responsive">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered" width="100%" cellspacing="0">
                    <thead>
                    <tr>
                      <th scope="col">훈련과정 코드번호</th>
                      <th scope="col">훈련코스 이름</th>
                      <th scope="col">학원명</th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${Course1}" var="Course">
                      <tr>
                        <th scope="row"></th>
                        <td>${Course.course_No}</td>
                        <td>${Course.name}</td>
                        <td>${Course.academy_No}</td>
                      </tr>
                    </c:forEach>
                    </tbody>
                  </table>
